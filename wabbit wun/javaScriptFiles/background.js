    ...
    constructor(game){
        ...
        this.levels = [
            ...
            [
                ...
                ['51 door 01056  096 00', '32', '32', '32', '40', '40', '32c', '40[eg]', '32c', '40', '32', '40c', '12', '51'] ,
            ...
            [
                ...
                ['51 door 01056 0480 04', '32', '40', '40', '32', '32crown', '40', '32', '48', '32', '40', '05', '35', '51'] ,
        ...
        for (let y = 0; y < level.length; y++){
            for (let x = 0; x < level[y].length; x++){
                ...
                switch (item.slice(2)) {
                    ...
                    case 'crown':
                        console.log('dawdwa')
                        this.game.crown = new Crown(this.game, x * this.tile_size - this.tile_size, y * this.tile_size - this.tile_size);
                        break;
                    default:
                        break;
                }
